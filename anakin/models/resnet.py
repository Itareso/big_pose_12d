...
class ResNet(nn.Module):
    ...
    def load_pretrained34(self):
        logger.info(f"Loading {type(self).__name__} pretrained models, modified resnet34")
        state_dict = torch.load("checkpoints/resnet34_pretrained.pth.tar")
